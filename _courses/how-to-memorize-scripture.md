...
The method is as follows. Each step will be explained in the following sections:

* [*Pick keywords*](#pick-keywords) from the verse
* [*Encode keywords*](#encode-keywords-as-mental-images) as images 
* [*Link images*](#link-images-to-a-memorable-location) to a memorable location
* [*Fix images*](#Fixing-images-for-long-term-retention) in memory for long term retention

We can remember these steps with the words "KEy LoaF." We're learning a method that is "key" to us memorizing our Daily Bread (thus "loaf"). You can picture in your mind by imagining a key sticking out of a loaf of bread or perhaps by imagining the surprise someone would have by biting into a loaf of bread and finding a key inside. 

Before diving into these steps, we're going to begin with some theory.

# You don't need to memorize every word

I want to begin with a principle that you may not agree with. **You don't need to memorize every word perfectly.** Unless your goal is a memory competition, forcing yourself to memorize every little "this" and "that" perfectly will only create fatigue and make you more likely to give up on Scripture memory &ndash; or at least stop enjoying the process. 

If your goal is *edification*, then the content is more important than having every tiny detail perfect. As an aside, unless you're memorizing in Greek, Hebrew, or Aramaic, you're memorizing a translation anyway and there are little details that translators have to add and skip over in order to translate. So some of those little details aren't in the original anyway.

That said, if you're like me, you want to be able to recall the verse with a high degree of accuracy. This will be what helps determine how many and what keywords need to be encoded &ndash; more on that in a minute. There are also two other reasons that we don't need to stress about encoding every word. 
...
The first step is memorizing a verse of Scripture is to determine what words you need to encode in order to accurately recall the verse. We call these words "keywords." Don't worry about what "encoding" means just yet. We'll cover that in the next section.
...
Principle 3 is the trumps the previous two. If you feel that you can accurately recall a verse without encoding a word, great. If you feel that you can't, then encode it anyway, even though you could probably fill it in from a pattern or from your knowledge of English, 
...
Different memory teachers teach encoding different ways. Some say that images should include action, emotion, and involve as many of the senses as possible. Others say that simpler, clear images are sufficient. I'm generally in the later camp. 

A memory friendly image is one that has the following characteristics (from [here](http://www.sevensigma.info/articles/4memory.html)):

* It is *three dimensional*, not flat
* It is *distinct* and has clear contours (sharp angles are a bonus too)
* It is *detailed*
* it is *in color*
* It's the *first image I think up* that has the above characteristics

We can remember these characteristics by phrase "TeDDy CaFe". Imagine a stuffed teddy bear sitting in a mug from your favorite café or coffee shop.  
...
When I think of "consider", an open book is the first thing that pops into my head. A book is 3D, it's distinct and has clear contours and sharp angles. I can imagine the size, red ribbon book mark, the shape of the paragraphs on the page and the large drop capital letter at the start of paragraph. I can picture the page numbers and heading, the color of the paper and the ink. Thus it is detailed and in color.
...
*Repeat this process for each keyword* and combine them into one image if you think it makes sense and it will help you remember. If not, you don't need to combine them. 

**Homework**: Encode at least three keywords from your verse using the TeDDy CaFe principles. 
...
To get a sense for the power of this method, stop and try to remember as many details about your bedroom. Imagine yourself walking in the door; then move around the room clockwise. What do you see? Where is your dresser relative to your bed? What about the closet? My guess is that you can remember the furniture, windows, doors, artwork, and other details. 

As humans, we remember physical spaces very easily and in great detail. By tying the information we want to remember to a physical space, it becomes much easier to remember it. Also, because we will mentally walk through the space in a set order, it becomes easy to recall things in a set order, which is what we want when memorizing Scripture.
...
This probably seems complicated, but we can boil down to: pick a place you know well, pick a few places in there, pick a route, and put the images on those places.
...
* Pick an object that you can visualize clearly that has sufficient distinct parts.
...
*Once you are comfortable with the method you can combine the encoding and the linking phases and link a keyword to a station after as soon as you encode it.*
...
The final phase of the method is fixing the images in long term memory. 

Any memory will fade if it is not recalled frequently enough. This is especially true with something like Scripture. We overcome this by repeatedly going over the mental journey we created in the linking and decoding the images stored there.

You need to review intensively for the first 4 days. Then it should be stuck pretty well in your mind. 
...
This method is not *difficult*, but does take some getting used to. For me the hardest part is learning to think up images to encode keywords, but this gets easier with practice.
